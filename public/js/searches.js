...
var busy = false;
function addTestBtn() {
  _modal_1["default"].addAction('Enviar alerta de teste', testAlert, {
    className: 'test-btn'
  });
  _modal_1["default"].addAction('A enviar...', null, {
    className: 'test-sending',
    disabled: true,
    hidden: true
  });
  _modal_1["default"].addAction('Enviado!', null, {
    className: 'test-sent',
    disabled: true,
    hidden: true
  });
  _modal_1["default"].addAction('Ocorreu um erro!', null, {
    className: 'test-error danger',
    disabled: true,
    hidden: true
  });
}
function testAlert() {
  return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var $testBtn, $sendingBtn, $sentBtn, $errorBtn, _modal_1$default$getD, data, req;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          busy = true;
          $testBtn = _modal_1["default"].$.querySelector('.test-btn');
          $sendingBtn = _modal_1["default"].$.querySelector('.test-sending');
          $sentBtn = _modal_1["default"].$.querySelector('.test-sent');
          $errorBtn = _modal_1["default"].$.querySelector('.test-error');
          _modal_1$default$getD = _modal_1["default"].getData(false), data = _modal_1$default$getD.data;
          if (data.token) {
            _context.next = 15;
            break;
          }
          (0, util_1.change)($testBtn, $errorBtn);
          _context.next = 12;
          return (0, util_1.wait)(3);
        case 12:
          (0, util_1.change)($errorBtn, $testBtn);
          busy = false;
          return _context.abrupt("return");
        case 15:
          (0, util_1.change)($testBtn, $sendingBtn);
          _context.prev = 16;
          _context.next = 19;
          return fetch('/api/test-alert', {
            method: 'POST',
            headers: {
        ...
        case 26:
          (0, util_1.change)($sendingBtn, $sentBtn);
          _context.next = 33;
          break;
        case 29:
          _context.prev = 29;
          _context.t2 = _context["catch"](16);
          (0, util_1.change)($sendingBtn, $errorBtn);
          console.error(_context.t2);
        case 33:
          _context.next = 35;
          return (0, util_1.wait)(3);
        case 35:
          (0, util_1.change)([$sentBtn, $errorBtn], $testBtn);
          busy = false;
        case 37:
        case "end":
  ...
  return __awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _modal_1["default"].setTitle('Adicionar pesquisa');
          _modal_1["default"].clear();
          _modal_1["default"].width(500);
          _modal_1["default"].addText('Cria uma pesquisa que envie alertas.');
          _modal_1["default"].addInput('query', 'Termo', {
            placeholder: 'One Direction',
            check: function check(value) {
              return !value && 'O termo de pesquisa é obrigatório.';
            }
          });
          _modal_1["default"].addInput('interval', 'Frequência (minutos)', {
            "default": '1',
          ...
          _modal_1["default"].addInput('token', 'Token do Chanify', {
            "default": LAST_CHANIFY_TOKEN,
            className: 'monospace',
            check: function check(value) {
              return !value && 'O token do Chanify é obrigatório.';
            }
          });
          _modal_1["default"].addSelect('sound', 'Toque', util_1.SOUNDS);
          _modal_1["default"].addSelect('interruptionLevel', 'Nível de Interrupção', util_1.INTERRUPTION_LEVEL);
        ...
        case 14:
          _yield$_modal_1$defau = _context2.sent;
  ...
  var _loop = function _loop() {
    ...
    $editBtn.addEventListener('click', function () {
      return __awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var req, search, _yield$_modal_1$defau2, success, data;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return fetch("/api/get-search/".concat(id));
            case 2:
              req = _context3.sent;
              _context3.next = 5;
              return req.json();
            case 5:
              ...
              _modal_1["default"].setTitle('Editar pesquisa');
              _modal_1["default"].clear();
              _modal_1["default"].width(500);
              _modal_1["default"].addInput('query', 'Termo', {
              ...
              _modal_1["default"].addSelect('sound', 'Toque', util_1.SOUNDS, search.sound);
              _modal_1["default"].addSelect('interruptionLevel', 'Nível de Interrupção', util_1.INTERRUPTION_LEVEL, search.interruptionLevel);
              _modal_1["default"].addAction('Cancelar', 'cancel', {
                className: 'secondary'
              });
              addTestBtn();
              ...
              return _modal_1["default"].open();
            case 19:
              _yield$_modal_1$defau2 = _context3.sent;
      ...
      return __awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _modal_1["default"].setTitle('Apagar pesquisa');
              _modal_1["default"].clear();
              _modal_1["default"].addText("Ir\xE1 deixar de receber alertas para a pesquisa ".concat($title.innerText.trim(), "."));
              _modal_1["default"].addAction('Cancelar', 'cancel');
              _modal_1["default"].addAction('Apagar', 'submit', {
                className: 'danger'
              });
              _context4.next = 7;
              return _modal_1["default"].open();
            case 7:
              _yield$_modal_1$defau3 = _context4.sent;
            ...
            case 11:
              _context4.next = 13;
              return fetch("/api/delete-search/".concat(id));
            case 13:
              location.reload();
            case 14:
            case "end":
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/ts/searches.ts");
/******/ 	
/******/ })()
;